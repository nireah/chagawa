...
<div class="container">
	<c:if test="${type==2}">
		<div>
			<div class="alert alert-info" id="u">
				사용가능한 차량번호 입니다.
			</div>
			<div class="form-inline" style="text-align: center">
				<label for="carNo">차량번호:</label>
				<input class="form-control" name="carNo" id="carNo" readonly="readonly" value="${param.carNo}">
	...
	<c:if test="${type==1}">
		<div>
			<div class="alert alert-danger" id="un">
				이미 사용중인 차량번호입니다.<br>다른 차량번호를 입력해 주세요.
			</div>
			<div class="form-inline" style="text-align: center">
				<label for="newCarNo">차량번호:</label>
				<input class="form-control" name="newCarNo" id="newCarNo" value="${param.carNo}">

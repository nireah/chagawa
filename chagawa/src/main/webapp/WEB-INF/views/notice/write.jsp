	...
	<div class="container">
		...
		<form action="write.do" method="post" id="writeForm" enctype="multipart/form-data">
			...
			<div style="display: inline-block; width: 48%;" class="form-group">
				<label for="startDate">시작일</label> <input name="startDate" id="startDate" class="form-control" type="date">
			</div>
			<div style="display: inline-block; float: right; width: 48%;" class="form-group">
				<label for="endDate">종료일</label> <input name="endDate" id="endDate" class="form-control" type="date">
			</div>
			<br>

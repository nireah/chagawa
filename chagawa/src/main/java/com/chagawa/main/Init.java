...
import com.chagawa.messageRoom.service.MessageRoomFRNServiceImpl;
import com.chagawa.messageRoom.service.MessageRoomIncreaseServiceimpl;
...
import com.chagawa.notice.service.CurrentNoticeListServiceImpl;
import com.chagawa.notice.service.NoticeDeleteServiceImpl;
import com.chagawa.notice.service.NoticeListServiceImpl;
import com.chagawa.notice.service.NoticeUpdateGnrServiceImpl;
import com.chagawa.notice.service.NoticeUpdateImgServiceImpl;
...
public class Init {
	...
	public static void init() {
		...
		serviceMap.put("messageAlertServiceImpl", new MessageAlertServiceImpl());
		...
		serviceMap.put("messageRoomFRNServiceImpl", new MessageRoomFRNServiceImpl());
		serviceMap.put("messageRoomIncreaseServiceImpl", new MessageRoomIncreaseServiceimpl());
		serviceMap.put("UTCServiceImpl", new UTCServiceimpl());
		...
		serviceMap.put("currentNoticeListServiceImpl", new CurrentNoticeListServiceImpl());		
		...
		serviceMap.put("noticeUpdateImgServiceImpl", new NoticeUpdateImgServiceImpl());
		serviceMap.put("noticeUpdateGnrServiceImpl", new NoticeUpdateGnrServiceImpl());
		...
		serviceMap.get("messageAlertServiceImpl").setDao(daoMap.get("messageDAO"));
		...
		serviceMap.get("messageRoomFRNServiceImpl").setDao(daoMap.get("messageRoomDAO"));
		serviceMap.get("messageRoomIncreaseServiceImpl").setDao(daoMap.get("messageRoomDAO"));
		serviceMap.get("UTCServiceImpl").setDao(daoMap.get("messageDAO"));
		...
		serviceMap.get("currentNoticeListServiceImpl").setDao(daoMap.get("noticeDAO"));
		...
		serviceMap.get("noticeUpdateImgServiceImpl").setDao(daoMap.get("noticeDAO"));		
		serviceMap.get("noticeUpdateGnrServiceImpl").setDao(daoMap.get("noticeDAO"));		
		...
		((MessageRoomController) controllerMap.get("messageRoomController"))
		.setMessageRoomWriteService(serviceMap.get("messageRoomWriteServiceImpl"));
		((MessageRoomController) controllerMap.get("messageRoomController"))
		.setMessageRoomFRNService(serviceMap.get("messageRoomFRNServiceImpl"));
		((MessageController) controllerMap.get("messageController"))
		.setMessageRoomIncreaseService(serviceMap.get("messageRoomIncreaseServiceImpl"));
		((MessageController) controllerMap.get("messageController"))
				.setMessageLogService(serviceMap.get("messageLogServiceImpl"));
		((MessageController) controllerMap.get("messageController"))
				.setMessageWriteService(serviceMap.get("messageWriteServiceImpl"));
		((MessageController) controllerMap.get("messageController"))
		.setMessageAlertService(serviceMap.get("messageAlertServiceImpl"));
		((MessageController) controllerMap.get("messageController"))
		.setUTCService(serviceMap.get("UTCServiceImpl"));
		...
		((NoticeController) controllerMap.get("noticeController"))
		.setCurrentNoticeListService(serviceMap.get("currentNoticeListServiceImpl"));
		((NoticeController) controllerMap.get("noticeController"))
		...
		((NoticeController) controllerMap.get("noticeController"))
		.setNoticeUpdateImgService(serviceMap.get("noticeUpdateImgServiceImpl"));
		((NoticeController) controllerMap.get("noticeController"))
		.setNoticeUpdateGnrService(serviceMap.get("noticeUpdateGnrServiceImpl"));
		((NoticeController) controllerMap.get("noticeController"))

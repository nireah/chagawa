...
public class AuthorityFilter extends HttpFilter implements Filter {
	...
	public void init(FilterConfig fConfig) throws ServletException {
		...
		// 포인트 관리 권한
		authMap.put("/point/list.do", 19);
		authMap.put("/point/charge.sub", 12);
		authMap.put("/point/withdraw.sub", 12);
		...
		// 후기 관리 권한
		authMap.put("/epilogue/write.do", 19);
		authMap.put("/epilogue/update.do", 19);
		authMap.put("/epilogue/delete.do", 19);
	}
